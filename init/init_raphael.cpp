...
void load_raphaelglobal() {
    ...
    property_override("ro.build.description", "taimen-user 8.1.0 OPM1.171019.021 4565141 release-keys");
}
...
void vendor_load_properties() {
    ...
    property_override_multifp("ro.build.fingerprint", "ro.system.build.fingerprint", "ro.bootimage.build.fingerprint",
        "ro.vendor.build.fingerprint", "google/taimen/taimen:8.1.0/OPM1.171019.021/4565141:user/release-keys");
